...
const resources = {
  en: {
    translation: {
      ...
      Send: "Send",
      Footer_P:
        "Come to May Coffee & Tea for the best experience. May Coffee & Tea – a place for peaceful moments.",
      ...
      "Freeze Trà Xanh": "Freeze Green Tea",
    },
  },
  vi: {
    translation: {
      ...
      Send: "Gửi",
      Footer_P:
        "Hãy đến với May Coffee & Tea để có những trải nghiệm tuyệt vời nhất. May Coffee & Tea – nơi gửi gắm những khoảng khắc bình yên.",
      ...
      "Freeze Trà Xanh": "Freeze Trà Xanh",
    },
  },
  cn: {
    translation: {
      ...
      Send: "发送",
      Footer_P:
        "来到May Coffee & Tea，享受最好的体验。五月咖啡和茶 - 享受宁静时光的地方。",
      "Cà Phê Sữa Đá": "冰牛奶咖啡",
